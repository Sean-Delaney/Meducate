        ...
        <div id='contactleft'>
          ...
          <div className='contactform'>
            <form className='substanceform'>
              ...
              <input type='text' placeholder='Question / Comment' required />
        ...
        <div id='contactright'>
          ...
          <div className='contactform'>
            <form className='substanceform'>
              ...
              <input type='text' placeholder='Enter any substance' className='lastinput' required/>
